...
var _ComplexTable = _interopRequireDefault(require("views/admin/dataTables/components/ComplexTable"));
var _columnsData = require("views/admin/dataTables/variables/columnsData");
var _tableDataComplex = _interopRequireDefault(require("views/admin/dataTables/variables/tableDataComplex.json"));
...
var _require = require('./api/jsm'),
  fetchJSMData = _require.fetchJSMData;
function Settings() {
  ...
  var _useState3 = (0, _react2.useState)(null),
    ...
    setApiData = _useState4[1]; // Estado para armazenar os dados da API
  ...
  var handleAPICall = /*#__PURE__*/function () {
  ...
  _react2.default.createElement(_react.Box, {
    py: "20px"
  ...
  _react2.default.createElement(_ComplexTable.default, {
    columnsData: _columnsData.columnsDataComplex,
    tableData: apiData || _tableDataComplex.default
