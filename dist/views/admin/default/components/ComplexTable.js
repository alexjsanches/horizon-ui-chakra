...
function ColumnsTable(props) {
  ...
  return /*#__PURE__*/_react2.default.createElement(_Card.default, {
    ...
    fontWeight: "700",
    lineHeight: "100%"
  }, "Complex Table"), /*#__PURE__*/_react2.default.createElement(_MainMenu.default, null)), /*#__PURE__*/_react2.default.createElement(_react.Table, _extends({}, getTableProps(), {
    variant: "simple",
    color: "gray.500",
    mb: "24px"
    ...
    return /*#__PURE__*/_react2.default.createElement(_react.Tr, _extends({}, row.getRowProps(), {
      ...
      if (cell.column.Header === "NAME") {
        ...
        data = /*#__PURE__*/_react2.default.createElement(_react.Flex, {
          ...
          h: "24px",
          me: "5px",
          color: cell.value === "Approved" ? "green.500" : cell.value === "Disable" ? "red.500" : cell.value === "Error" ? "orange.500" : null,
          as: cell.value === "Approved" ? _md.MdCheckCircle : cell.value === "Disable" ? _md.MdCancel : cell.value === "Error" ? _md.MdOutlineError : null
        }), /*#__PURE__*/_react2.default.createElement(_react.Text, {
          color: textColor,
          fontSize: "sm",
          fontWeight: "700"
